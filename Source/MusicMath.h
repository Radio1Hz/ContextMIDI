...
public:
	...
	double GetNumberOfTicksElapsed(juce::int64 startTimestamp);
	void saveMidiPattern(juce::MidiMessageSequence midiSequence);
	void saveMidiPatternTest();
